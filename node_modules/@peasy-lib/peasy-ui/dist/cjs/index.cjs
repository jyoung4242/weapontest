            ...
            for (let t = l, e = r.length, i = l; t < e; t++, i++) {
                ...
                if (i == null) {
                    ...
                    const i = UIView.create(this.element.parentElement, t, this.template.cloneNode(true), {
                        parent: this,
                        prepare: false,
                        sibling: c?.element ?? this.element
                    });
                    u.push(i);
                    c = i;
                    continue;
    ...
    static parse(t, e, i, n) {
        ...
        if (t.nodeType === 3) {
            ...
            while (r != null) {
                ...
                const c = l.match(this.regexConditionalValue);
                let a;
                let f = true;
                if (l.startsWith("(")) {
            ...
            h.push(...Object.keys(t.attributes ?? []).reverse().map((h => {
                ...
                const l = [ o.value ];
                let u = 0;
                let c = l[u].match(this.regexValue);
                while (c != null) {
                    let {before: n, property: h, after: a} = c.groups;
                    let f = false;
                    if (h.startsWith("|")) {
                        f = true;
    ...
    static parseAttribute(t, e, i, s, n, h) {
        ...
        if (u !== "@") {
            ...
            if (i != null) {
                ...
                p = t;
                t = e;
            } else if (c === "|") d = true; else if (l !== "checked") t.setAttribute(l, "");
        }
        return [ this.bind({
            selector: t,
            attribute: l,
