export class Vector {
  ...
  public constructor(x: number | number[] | Vector | string = 0, y = 0, z = 0) {
  ...
  public toVector3(): Vector3 {
    return !(this instanceof Vector3) ? new Vector3(this.x, this.y, this.z) : this;
  }
}
